...
- sometimes, it's possible that instead of writing a parser, you might write a library that handles strings of data, either _en mass_ or in a stream. For the nerds, this might come in the form of implementing a protocol (think redis), or, in the case of lesser-nerds, re-inventing git.
